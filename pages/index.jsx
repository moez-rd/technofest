    ...
    <Fragment>
      ...
      <div className=" bg-gray-300">
        ...
        <header className="flex flex-col items-center justify-center pb-[100px] pt-[40vh] text-center">
          <div data-aos="fade-up" className="relative w-56 sm:w-72 md:w-80">
          ...
          <h1
            data-aos="fade-up"
            data-aos-delay="50"
            className="bg-gradient-to-br from-blue-500 via-primary-500 to-pink-500 bg-clip-text font-metal-storm text-4xl lowercase text-transparent 2xl:text-6xl">
            Technology Festival
          </h1>
          <p
            data-aos="fade-up"
            data-aos-delay="100"
            className="mt-2 max-w-xl text-sm sm:text-lg md:text-2xl">
            Himpunan Mahasiswa Sistem Komputer Universitas Sriwijaya
          </p>
          <div data-aos="fade-up" data-aos-delay="150" className="mt-10">
            <Link href="/#content">
      ...
      <main
        ...
        <section
          ...
          <div className="mt-10 md:max-w-lg lg:mt-0">
            <h2
              data-aos="fade-left"
              className="bg-gradient-to-br from-blue-500 via-primary-500 to-pink-500 bg-clip-text font-robot font-medium tracking-[10px] text-transparent">
              TENTANG
            </h2>
            <p
              data-aos="fade-left"
              data-aos-delay="50"
              className="px-10 text-3xl text-gray-700 sm:px-0 sm:text-4xl">
              <span className="font-semibold">Selamat datang</span> di Technofest 2022
            </p>
            <p data-aos="fade-left" data-aos-delay="100" className="mt-5 text-gray-500">
        ...
        <section id="competition" className="relative flex flex-col sm:items-center">
          ...
          <div className="z-10 mt-10 grid grid-cols-1 gap-y-10 text-center sm:grid-cols-2 sm:gap-x-10 xl:grid-cols-4 xl:gap-y-0">
            <div
              data-aos="zoom-in"
              data-aos-delay="100"
              className="flex flex-col items-center rounded-xl p-5 shadow-xl backdrop-blur transition duration-300 hover:scale-105">
